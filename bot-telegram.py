...
CHAVE_API = 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'
...
def realizarcadastro(mensagem):
    texto = '''
Para realizar o cadastro, vá até a recepção do hospital e traga seu RG e CPF.
...
/noite: Agendar para o turno noite
